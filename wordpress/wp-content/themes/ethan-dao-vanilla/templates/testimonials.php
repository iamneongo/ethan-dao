...
<html lang="vi">
  <head>
    ...
    <title>Testimonials | Ethan Dao</title>
    <meta name="description" content="Client testimonials and review highlights for Ethan Dao." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-awards.png" alt="Testimonials" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Niềm tin khách hàng</span><h1>Testimonials</h1><p>Giao tiếp rõ ràng, hướng dẫn vững vàng và kết quả thực tế từ tìm kiếm đến closing.</p></div></section>
