...
<html lang="vi">
  <head>
    ...
    <title>Home Valuation | Ethan Dao</title>
    <meta name="description" content="Request a Dallas-Fort Worth home valuation from Ethan Dao." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-neighborhood.jpg" alt="Home Valuation" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Nắm rõ giá trị căn nhà</span><h1>Home Valuation</h1><p>Nhận góc nhìn thực tế về giá trị nhà, nhu cầu người mua và lựa chọn bán nhà tại DFW.</p></div></section>
...
<section class="valuation page-valuation"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-neighborhood.jpg" alt="DFW aerial" /><div></div><div class="container reveal"><h2 class="h-section-title">Căn nhà của bạn tại Dallas-Fort Worth đáng giá bao nhiêu?</h2><div class="check-row"><span><svg><use href="#icon-check"/></svg>Định giá nhanh</span><span><svg><use href="#icon-check"/></svg>Tư vấn địa phương chuyên sâu</span><span><svg><use href="#icon-check"/></svg>Bán với giá tốt hơn</span></div><form data-static-form><input type="text" placeholder="Nhập địa chỉ nhà của bạn" /><button class="btn-gold">Nhận định giá nhà miễn phí</button><p class="form-success" hidden>Cảm ơn bạn. Ethan sẽ xem địa chỉ và liên hệ lại.</p></form></div></section><section class="page-section"><div class="content-split"><div class="reveal"><h2 class="h-section-title">Điều gì tạo nên giá trị?</h2><p>Tình trạng nhà, nâng cấp, diện tích đất, vị trí, nhu cầu trường học, giao dịch gần đó, cạnh tranh hiện tại, lãi suất và ưu đãi builder đều ảnh hưởng đến mức giá người mua sẵn sàng trả.</p></div><div class="highlight-panel reveal"><p>Phân tích so sánh thị trường</p><p>Nhu cầu người mua theo khu vực</p><p>Gợi ý chuẩn bị và định giá</p></div></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc cùng Ethan</h2><p>Sẵn sàng mua bán nhà tại Dallas-Fort Worth? Dù mua, bán, chuyển đến DFW hay đầu tư, Ethan Dao mang đến tư vấn rõ ràng, hỗ trợ song ngữ Việt-Anh và chiến lược thực tế từ cuộc gọi đầu tiên đến ngày closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
