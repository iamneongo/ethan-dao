...
<html lang="vi">
  <head>
    ...
    <title>Buyer Information | Ethan Dao</title>
    <meta name="description" content="Tell Ethan Dao what you are looking for in a Dallas-Fort Worth home." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-5.jpg" alt="Buyer Information" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Start the search</span><h1>Buyer Information</h1><p>Share your home goals so Ethan can recommend neighborhoods, builders, and properties that fit.</p></div></section>
