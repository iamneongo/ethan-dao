...
<html lang="vi">
  <head>
    ...
    <title>Services | Ethan Dao</title>
    <meta name="description" content="Mua nhà, selling, and investing services from Ethan Dao." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-houston.jpg" alt="Services" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">How Ethan helps</span><h1>Services</h1><p>Strategic support for buying, selling, investing, and relocating across Dallas-Fort Worth.</p></div></section>
...
<section class="page-section"><div class="container"><div class="service-grid"><article class="reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-newbuild.jpg" alt="Mua nhà" /><div><h3>Mua nhà</h3><p>Market education, property search, tours, negotiations, inspections, financing coordination, and post-purchase guidance.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>">Start Mua nhà</a></div></article><article class="reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg" alt="Bán nhà" /><div><h3>Bán nhà</h3><p>Pricing, preparation, content strategy, social distribution, showings, offer review, and closing coordination.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>">Start Bán nhà</a></div></article><article class="reveal"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-ranch.jpg" alt="Đầu tư" /><div><h3>Đầu tư</h3><p>Neighborhood demand, rental potential, builder incentives, resale lens, and portfolio planning across DFW.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>">Start Đầu tư</a></div></article></div></div></section><section class="newsletter"><div class="newsletter-inner reveal"><h2 class="h-section-title">Kinh nghiệm gặp gỡ sự tận tâm</h2><p>Nhận cập nhật thị trường DFW, nhà mới xây, ưu đãi builder và video mới từ Ethan Dao - Mua Bán Nhà Dallas Texas.</p><form data-static-form><input type="text" placeholder="HỌ TÊN" /><input type="email" placeholder="EMAIL" /><button class="btn-gold">Gửi thông tin</button><p class="form-success" hidden>Cảm ơn bạn. Đội ngũ của Ethan sẽ liên hệ sớm.</p></form><label><input type="checkbox" /> <span>Tôi đồng ý để Ethan Dao liên hệ qua điện thoại, email và tin nhắn về dịch vụ bất động sản. Có thể phát sinh phí tin nhắn và dữ liệu. <a href="<?php echo esc_url(home_url('/contact/')); ?>">Chính sách bảo mật</a>.</span></label></div></section><section id="work" class="work"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-brick2story.jpg" alt="Dallas-Fort Worth home exterior" /><div></div><div class="work-inner reveal"><span class="h-kicker light">Cùng bắt đầu</span><h2 class="h-section-title">Làm việc cùng Ethan</h2><p>Sẵn sàng mua bán nhà tại Dallas-Fort Worth? Dù mua, bán, chuyển đến DFW hay đầu tư, Ethan Dao mang đến tư vấn rõ ràng, hỗ trợ song ngữ Việt-Anh và chiến lược thực tế từ cuộc gọi đầu tiên đến ngày closing.</p><a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-gold">Kết nối ngay</a></div></section></main>
    <footer class="footer">
      <div class="container">
