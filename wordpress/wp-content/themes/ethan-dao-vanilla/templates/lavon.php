...
<html lang="vi">
  <head>
    ...
    <title>Lavon Real Estate | Ethan Dao</title>
    <meta name="description" content="Lavon real estate and new-build guidance from Ethan Dao." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-newbuild.jpg" alt="Lavon Real Estate" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Where Ethan works</span><h1>Lavon Real Estate</h1><p>Lavon là thị trường phù hợp với nhà mới xây, mức giá dễ tiếp cận, nhiều ưu đãi builder và không gian rộng hơn cho người mua.</p></div></section>
