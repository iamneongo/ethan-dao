...
<html lang="vi">
  <head>
    ...
    <title>Hợp tác đại lýs | Ethan Dao</title>
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-houston.jpg" alt="Hợp tác đại lýs" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Sẵn sàng nhận referral</span><h1>Hợp tác đại lýs</h1><p>Hợp tác cùng Ethan để hỗ trợ khách mua, khách bán, khách chuyển đến DFW và nhu cầu song ngữ Việt-Anh.</p></div></section>
