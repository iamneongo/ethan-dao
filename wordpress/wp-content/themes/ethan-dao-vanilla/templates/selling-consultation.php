...
<html lang="vi">
  <head>
    ...
    <title>Bán nhà Consultation | Ethan Dao</title>
    <meta name="description" content="Request a selling consultation with Ethan Dao." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-home-8.jpg" alt="Bán nhà Consultation" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Price and position</span><h1>Bán nhà Consultation</h1><p>Start with goals, timing, condition, and neighborhood context before deciding how to launch.</p></div></section>
