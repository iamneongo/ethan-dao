...
<html lang="vi">
  <head>
    ...
    <title>Gia nhập đội ngũ Ethan Dao</title>
    <meta name="description" content="Explore collaboration and team opportunities with Ethan Dao." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-awards.png" alt="Gia nhập đội ngũ" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Grow together</span><h1>Gia nhập đội ngũ</h1><p>Dành cho agent và đối tác coi trọng giao tiếp rõ ràng, nội dung chất lượng và cách làm đặt khách hàng lên trước.</p></div></section>
