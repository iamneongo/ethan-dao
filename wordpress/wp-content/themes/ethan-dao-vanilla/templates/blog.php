...
<html lang="vi">
  <head>
    ...
    <title>DFW Real Estate Notes | Ethan Dao</title>
    <meta name="description" content="Market notes, neighborhood guides, and real estate education from Ethan Dao." />
  ...
  <body <?php body_class(); ?>><?php wp_body_open(); ?>
    ...
    <main class="subpage-main"><section class="subpage-hero"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/ethan-aerial-neighborhood.jpg" alt="DFW Real Estate Notes" /><div></div><div class="subpage-hero-inner reveal"><span class="h-kicker light">Blog</span><h1>DFW Real Estate Notes</h1><p>Neighborhood insights, new-build notes, and market education for buyers and sellers.</p></div></section>
